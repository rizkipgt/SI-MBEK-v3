...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Kambing>
 */
class KambingFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        $jenis = $this->faker->randomElement(['Etawa', 'Boer', 'Skeang', 'Saaren']);
        $jenisKelamin = $this->faker->randomElement(['Jantan', 'Betina']);

        // buat nama sesuai format
        $name = "Kambing {$jenis} {$jenisKelamin}";

        // Hitung harga berdasarkan berat_now (2–90 kg => 1–14 juta)
        $minPrice = 1000000;
        $maxPrice = 14000000;
