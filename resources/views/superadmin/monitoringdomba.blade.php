            ...
            <div class="bg-white shadow-2xl rounded-2xl p-6">
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-8 gap-4 border-b pb-4">
                    <div class="flex items-center gap-3">
                        <a href="{{ route('super-admin.domba.show', ['domba' => $domba->id]) }}" class="inline-flex items-center px-3 py-1.5 bg-gray-100 border border-gray-300 rounded-lg font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-200 transition">
