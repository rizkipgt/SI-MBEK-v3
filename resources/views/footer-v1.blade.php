    ...
    <div class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            <div class="col-span-full lg:col-span-1">
                ...
                <a class="flex-none text-xl font-semibold dark:text-white uppercase" href="#">SI MBEK</a>
            </div>
            <!-- End Col -->

            <div class="col-span-1">
                <h4 class="font-semibold text-gray-100">Raman Farm </h4>

                <div class="mt-3 grid space-y-3 text-white">
                    <p>Sahabat Raman Farm
                        🏢 CV. Raman Farm Sejahtera
                        📍Rukti Endah, Kec. Seputih Raman, Kab. Lampung Tengah, Lampung 34155
                        📲 0821-8379-0001
                        ⬇Link Shopee:
                        bit.ly/zonaternak </p>
            ...
            <div class="col-span-1">
                ...
                <div class="mt-3 grid space-y-3">
                    <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200"
                            href="#">Raman Farm ID</a></p>
            ...
            <div class="col-span-2">
                ...
                <div class="w-50 h-50 mx-auto p-4ss">
                    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7950.0143937884!2d105.40036986224031!3d-4.93843694115488!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e40a187e1974ac7%3A0x365430d9e94bbbe!2sRaman%20Farm%20Sejahtera!5e0!3m2!1sid!2sid!4v1723012550248!5m2!1sid!2sid"
                            width="100%" height="" class="border-0 w-full" allowfullscreen="" loading="lazy"
    ...
    <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
        <div class="flex justify-between items-center">
            <p class="text-sm text-gray-400 dark:text-neutral-400">
                ...
                </script> SI MBEK. PMKU UNILA || LABKOM UNILA.
            </p>
        </div>
        <!-- End Col -->
