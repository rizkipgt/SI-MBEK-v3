<x-home-layout>
    <x-navbar/>
    <main class="mt-6 max-w-[70rem] mx-auto my-10 ">
        <!-- Hero -->
        <div class="max-w-[70rem] mx-auto px-4 sm:px-6 lg:px-8 my-8 bgs-red-400">
            <!-- Grid -->
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight">
                        Raman Farm </br> <span class="text-blue-600">SI MBEK</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">
                        Pantau Pertumbuhan, Tingkatkan Produktivitas</p>
                    ...
                    <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                            href="https://wa.me/+6282183790001" target="_blank">
                            Contact US
                    ...
                    <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                        ...
                        <div class="py-5">
                            <div class="flex space-x-1">
                                <svg class="size-4 text-yellow-700" width="51" height="51" viewBox="0 0 51 51"
                ...
                <!-- End Col -->
                <div class="md:w-96 ml-auto  bg-gray-700 rounded-full">
                    <div class="relative mss-4 i  bg-gray-200 rounded-s-full  rounded-t-full ">
                        <img class="w-full " src="{{ asset('logo/kambing6 1.png') }}" alt="Kambing">
        ...
        <div data-aos="fade-up" data-aos-duration="3000" class="bg-white py-6 sm:py-8 lg:py-12">
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                <!-- text - start -->
                <div class="mb-10 md:mb-16">
                    <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Informasi Kambing</h2>
                    <p class="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">Pelajari lebih lanjut tentang jenis-jenis kambing, vaksin yang diperlukan, dan cara merawat mereka dengan baik untuk kesehatan yang optimal.</p>
                </div>
                <!-- text - end -->
        
                <!-- Informasi Kambing - start -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                    <!-- Jenis Kambing - start -->
                    <div class="bg-gray-100 p-6 rounded-lg shadow-lg">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Jenis-jenis Kambing</h3>
                        <ul class="list-disc pl-5 text-gray-700">
                            <li><strong>Kambing Peranakan Etawa (PE):</strong> Kambing unggulan yang diambil susunya.</li>
                            <li><strong>Kambing Boer:</strong> Kambing pedaging yang sangat cepat pertumbuhannya.</li>
                            <li><strong>Kambing Kacang:</strong> Kambing lokal yang mudah dipelihara dan tahan terhadap kondisi lingkungan.</li>
                            <li><strong>Kambing Saanen:</strong> Kambing perah dengan produksi susu yang tinggi.</li>
                        </ul>
                    </div>
                    <!-- Jenis Kambing - end -->
                    ...
                    <!-- Jenis Vaksin - start -->
                    <div class="bg-gray-100 p-6 rounded-lg shadow-lg">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Jenis Vaksin Kambing</h3>
                        <ul class="list-disc pl-5 text-gray-700">
                            <li><strong>Vaksin Enterotoxemia:</strong> Melindungi kambing dari penyakit pencernaan.</li>
                            <li><strong>Vaksin Tetanus:</strong> Mencegah infeksi tetanus pada kambing, terutama setelah prosedur bedah seperti kastrasi.</li>
                            <li><strong>Vaksin CCPP (Contagious Caprine Pleuropneumonia):</strong> Melindungi kambing dari penyakit paru-paru yang serius.</li>
                            <li><strong>Vaksin Foot-and-Mouth Disease (FMD):</strong> Mencegah penyakit mulut dan kuku pada kambing.</li>
                        </ul>
                    </div>
                    <!-- Jenis Vaksin - end -->
        
                    <!-- Informasi Tambahan Kambing - start -->
                    <div class="bg-gray-100 p-6 rounded-lg shadow-lg">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Perawatan Kambing</h3>
                        <ul class="list-disc pl-5 text-gray-700">
                            <li><strong>Perawatan Harian:</strong> Pastikan kambing mendapatkan makanan dan air yang cukup setiap hari, serta kebersihan kandang yang terjaga.</li>
                            <li><strong>Pemeriksaan Kesehatan Berkala:</strong> Lakukan pemeriksaan kesehatan rutin oleh dokter hewan untuk memastikan kambing tetap sehat dan bebas dari penyakit.</li>
                            <li><strong>Manajemen Kandang:</strong> Kandang yang baik harus memiliki ventilasi yang cukup, pencahayaan alami, dan perlindungan dari cuaca buruk.</li>
                            <li><strong>Pakan yang Tepat:</strong> Berikan pakan yang sesuai dengan kebutuhan kambing, seperti rumput, jerami, dan konsentrat sesuai dengan usia dan kondisi kesehatan kambing.</li>
                        </ul>
                    </div>
                    <!-- Informasi Tambahan Kambing - end -->
        
                    <!-- Tips Ternak Kambing - start -->
                    <div class="bg-gray-100 p-6 rounded-lg shadow-lg">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Tips Ternak Kambing</h3>
                        <ul class="list-disc pl-5 text-gray-700">
                            <li><strong>Pilih Bibit yang Baik:</strong> Pilih kambing dengan genetik unggul dan sehat untuk memulai ternak.</li>
                            <li><strong>Manajemen Pakan:</strong> Pastikan kambing mendapatkan nutrisi yang cukup untuk tumbuh dan berkembang dengan baik.</li>
                            <li><strong>Kebersihan Kandang:</strong> Kebersihan kandang sangat penting untuk mencegah penyakit dan menjaga kesehatan kambing.</li>
                            <li><strong>Pengendalian Penyakit:</strong> Vaksinasi rutin dan perawatan kesehatan yang baik dapat mencegah penyakit serius pada kambing.</li>
                        </ul>
                    </div>
                    <!-- Tips Ternak Kambing - end -->
                </div>
                <!-- Informasi Kambing - end -->
            </div>
        </div>
            ...
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <div data-aos="fade-up" data-aos-duration="3000"
                    ...
                    <a href="#"
                        ...
                        <img src="{{ asset('pageimage/kambing2.jpeg') }}" loading="lazy" alt="Photo by Minh Pham"
                    ...
                    <a href="#"
                        ...
                        <img src="{{ asset('pageimage/depan-raman.jpeg') }}" loading="lazy" alt="Photo by Magicle"
                            class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                    ...
                    <a href="#"
                        class="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:col-span-2 md:h-80">
                        <img src="{{ asset('pageimage/kambing3.jpeg') }}" loading="lazy"
                    ...
                    <a href="#"
                        class="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-80">
                        <img src="{{ asset('pageimage/kambing4.jpeg') }}"" loading="lazy"
